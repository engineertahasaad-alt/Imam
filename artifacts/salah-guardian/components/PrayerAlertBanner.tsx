...
export function PrayerAlertBanner({
  ...
  return (
    <Animated.View
      style={[
        styles.wrapper,
        { bottom: bottomInset + 12, transform: [{ translateY: slideAnim }] },
      ]}
      ...
      >
          ...
          <View style={styles.titleBlock}>
            <View style={styles.dotRow}>
              <View
                style={[
                  styles.liveDot,
                  { backgroundColor: isNow ? "#4ade80" : "#86efac" },
                ]}
              />
              <Text style={styles.liveLbl}>
                {isNow ? "PRAYER TIME" : "UPCOMING"}
              </Text>
            </View>
        ...
        >
          ...
          <Text style={styles.startBtnText}>
            {isNow ? "Start Prayer Detection" : "Get Ready — Start Detection"}
          </Text>
        </TouchableOpacity>
      </Animated.View>
    </Animated.View>
